...
function Finalcalculator() {
  ...
  return (
    <div className="Calculator">
      ...
      <Keypad>
        <Button onClick={handleClick} label="C" value="clear" id="clr" />
        ...
        <Button onClick={handleClick} label="/" value="/" type="oprator" />
        ...
        <Button onClick={handleClick} label="x" value="*" type="oprator" />
